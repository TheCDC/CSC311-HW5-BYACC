...
/* "y.c":45  */ /* lalr1.java:91  */

/* "y.c":47  */ /* lalr1.java:92  */

/**
 * A Bison parser, automatically generated from <tt>09.y</tt>.
 *
...
/* Tokens.  */
  ...
  case 5:
  if (yyn == 5)
    /* "09.y":22  */ /* lalr1.java:489  */
    { System.out.println("Prod4"); };
  break;
    


/* "y.c":345  */ /* lalr1.java:489  */
        default: break;
      }
...
/* YYR2[YYN] -- Number of symbols on the right hand side of rule YYN.  */
  ...
  private static final String[] yytname_init()
  {
    return new String[]
    {
  "$end", "error", "$undefined", "b", "c", "$accept", "S", "B", "C", null
    };
  }
